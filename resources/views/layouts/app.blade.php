...
<body class="user_panel">
    ...
    <div class="cart_layout" id='cart_layout'>
        <div class="col-md-10 col-lg-6" id="cart_item">
            <i class="fa-solid fa-xmark cancel" id="close"></i>
            <div id="carts">
            </div>
            @auth
    ...
    <script>
        $(document).ready(function() {
            ...
            document.addEventListener('click', (event) => {
                if(document.getElementById('cart_layout').contains(event.target) && !document.getElementById('cart_item').contains(event.target)){

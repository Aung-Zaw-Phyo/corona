        ...
        <div class="card">
            <div class="card-body text-dark">
                    <div>
                        ...
                        <form action="{{ route('admin-user.update', $admin_user->id) }}" id="create-form" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="tel" name="phone" class="form-control" id="phone" value="{{ old('phone', $admin_user->phone) }}">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                              ...
                              <div class="mb-3">
                                ...
                                <select name="level" class="form-select select2" id="level">
                                    <option value="1" @if ($admin_user->level == 1) selected @endif>1</option>
                                    <option value="2" @if ($admin_user->level == 2) selected @endif>2</option>
                                </select>
                              </div>
                              <div class="mb-3">
                                ...
                                <div class="preview_img d-flex align-items-start">
                                    @if ($admin_user->profile_img_path())
                                        <img width="65" class="m-1" src="{{ $admin_user->profile_img_path() }}"/>
                                    @endif
                                </div>
                              </div>
                            <div class="mb-3">
...
@endsection
@section('script')
    {!! JsValidator::formRequest('App\Http\Requests\UpdateAdminUser', '#create-form') !!}
    <script>

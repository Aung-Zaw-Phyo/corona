...
@section('content')
    <div class="card">
        <div class="card-body">
            <div class="mb-5">
                <a href="{{ route('admin-user.create') }}" class="btn btn-theme"><i class="fa-solid fa-plus"></i> Create Admin</a>
            </div>
            
            <div>
                <div>
                    <table class="table table-bordered w-100" id="admin_user_table">
                        <thead>
                            <th></th>

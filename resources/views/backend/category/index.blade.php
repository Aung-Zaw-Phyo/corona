...
@section('content')
    <div class="card">
        <div class="card-body">
            <div class="mb-5">
                <a href="{{ route('category.create') }}" class="btn btn-theme"><i class="fa-solid fa-plus"></i> Create Category</a>
            </div>
            
            <div>
                <div>
                    <table class="table table-bordered w-100" id="category_table">
                        <thead>
                            <th></th>
    ...
    <script>
        $(document).ready(function () {
            let data_table = $('#category_table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '/admin/category/data-table/ssd',
                columns: [
